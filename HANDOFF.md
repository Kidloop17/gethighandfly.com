...
Ждём подтверждения владельца → Фаза 2 (дизайн).
...
## Следующий шаг
**Фаза 2 — Дизайн**: 3 направления на выбор (Data-brutal, Kite-poster, Локальный колорит).
Ждать подтверждения Фазы 1 перед стартом.
